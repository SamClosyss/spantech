...
class ThemePrimeWebsiteSale(WebsiteSale):
    ...
    def cart_update_json(self, product_id, line_id=None, add_qty=None, set_qty=None, display=True, **kw):
        ...
        if sale_order and response:
            for line in sale_order.order_line:
                if line.product_id and line.product_id.free_qty > 0:
                    line.delivery_approx_time = 'Delivery in 2-3 Days '
                else:
                    line.delivery_approx_time = html2plaintext(line.product_id.out_of_stock_message)
