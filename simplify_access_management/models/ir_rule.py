                ...
                if model_numeric_id and isinstance(model_numeric_id, int) and self.env.user:
                    ...
                    if access_domain_ah_ids:
                        ...
                        for access in access_domain_ah_ids.sudo():
                            dom = safe_eval(access.domain, eval_context)
                            
                            if not dom and isinstance(dom,list):
                                # if length>1:
                                #     domain_list += ['|', (1, '=', 1)]
                                # else:
                                # all_record_dom= [('id', '!=', False)]
                                if length>1:
                                ...
                                if res:
                                    for domain_tuple in res:
                                        ...
                                        if isinstance(domain_tuple,tuple) and domain_tuple[0] == 'company_id':
                                            ...
                                            # if company_domain_tuple not in domain_list:
                                            # domain_list.append(company_domain_tuple)
                                            # domain_list.insert(0, '&')
                                            # if company_domain_tuple not in company_domain:
                                            # company_domain.insert(0, '&')
                            ...
                            if dom:
                                ...
                                for dom_tuple in dom:
                                    if isinstance(dom_tuple, tuple):
                                        ...
                                        #             if isinstance(domain_tuple,tuple) and domain_tuple[0] == 'company_id':
                                        #                 company_domain_tuple = ('company_id','in',access.access_management_id.company_ids.ids)
                                        #                 dom_tuple+company_domain_tuple
                                                        # if company_domain_tuple not in domain_list:
                                                        #     domain_list.append(company_domain_tuple)
                                                        #     domain_list.insert(0, '&')
                                    else:
                                                ...
                                                if domain_tuple[0] == 'company_id':
                                                    if len(all_company)>1:
                                                        ...
                                                        if isinstance(domain_tuple[2],list):
                                                            ...
                                                            # else:
                                                            #     com_domain.append(domain_tuple)
                                                    # domain_list.append(('company_id','in',access.access_management_id.company_ids.ids))
                                                    # domain_list.insert(0, '&')
                                                #     # company_domain += ['|',domain_tuple] + domain_list
                                                #     # for access_management_id in access_management_ids_list:
                                                    # for company in access_domain_ah_ids.access_management_id.company_ids.ids:
                                                    #     if company in all_company:
                                                    #         all_company.remove(company)
                                                #     if domain_list:
                                                #         # if len(domain_tuple[2]) > 1:
                                                #             company_domain += ['|','&',('company_id','in',access.access_management_id.company_ids.ids)] + domain_list + [('company_id','in',all_company)]
                                                #         # else:
                                                #         #     company_domain += ['&',('company_id','in',access.access_management_id.company_ids.ids)] + domain_list
                                                #         # company_domain = ['|','&','|',('company_id','in',access.access_management_id.company_ids.ids)] + [('user_id', 'in', [6]), ('id', '!=', False)] + [('company_id','in',all_company)]
                                                #     else :
                                                #         if access.access_management_id.is_apply_on_without_company:
                                                #             company_domain += ['|',('company_id','in',access.access_management_id.company_ids.ids)] +[('company_id','in',all_company + [False])]
                                                #         else:
                                                #             company_domain += ['|',('company_id','in',access.access_management_id.company_ids.ids)] +[('company_id','in',all_company)]
                                                # domain_list.insert(0,'|')
                                                # domain_list.append(domain_tuple)
                                # if length > 1:
                                #     domain_list.insert(0, '|')
                        ...
                        if domain_list:
                            if com_domain:
                                ...
                                # if all_record_dom:
                                #     domain_list.insert(0, '|')
                                #     domain_list+=all_record_dom
                                # company_domain.insert(0, '|')
                                # company_domain+=com_domain
                            # if company_domain:
                            #     return company_domain
                                # return ['|','&',('company_id','in',access.access_management_id.company_ids.ids),domain_list[0],('company_id','in',all_company)]
