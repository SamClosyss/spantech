odoo.define('swara_web.cart', function (require) {
'use strict';
...
publicWidget.registry.websiteSwaraCartLink = publicWidget.Widget.extend({
    selector: '#top_menu_container a.swara-cart-popover',
    events: {
