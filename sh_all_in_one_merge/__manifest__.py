...
# Part of Softhealer Technologies.
{
    ...
    "data": [
        ...
        "sh_ecommerce_categories_merge/views/product_category.xml",
        ...
        "sh_merge_mrp_order/security/ir.model.access.csv",
        "sh_merge_mrp_order/views/res_config_setting.xml",
        "sh_merge_mrp_order/wizard/merge_mrp_order.xml",
